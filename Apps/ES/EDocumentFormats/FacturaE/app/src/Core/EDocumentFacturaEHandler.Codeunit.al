...
codeunit 10776 "E-Document Factura-E Handler" implements IStructuredFormatReader
{
    ...
    begin
        ...
        XmlNamespaces.AddNamespace('fe', FacturaENamespaceLbl);
        ...
        if FacturaEXML.SelectSingleNode('/fe:Facturae/Invoices/Invoice/Corrective', XmlNamespaces, XMLNode) then
...
#pragma warning disable AA0139 // false positive: overflow handled by SetStringValueInField
    ...
    var
        ...
        VendorNo: Code[20];
    begin
        EDocumentXMLHelper.SetStringValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceHeader/InvoiceNumber', MaxStrLen(EDocumentPurchaseHeader."Sales Invoice No."), EDocumentPurchaseHeader."Sales Invoice No.");
        EDocumentXMLHelper.SetDateValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceIssueData/IssueDate', EDocumentPurchaseHeader."Document Date");
        EDocumentXMLHelper.SetCurrencyValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceIssueData/InvoiceCurrencyCode', MaxStrLen(EDocumentPurchaseHeader."Currency Code"), EDocumentPurchaseHeader."Currency Code");
        ...
        EDocumentXMLHelper.SetNumberValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceTotals/TotalGrossAmountBeforeTaxes', EDocumentPurchaseHeader."Sub Total");
        EDocumentXMLHelper.SetNumberValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceTotals/TotalTaxOutputs', EDocumentPurchaseHeader."Total VAT");
        EDocumentXMLHelper.SetNumberValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceTotals/InvoiceTotal', EDocumentPurchaseHeader.Total);
        EDocumentXMLHelper.SetNumberValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceTotals/TotalOutstandingAmount', EDocumentPurchaseHeader."Amount Due");
        EDocumentXMLHelper.SetDateValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/InvoiceHeader/InvoiceDocumentReference/ReferencedDocumentDate', EDocumentPurchaseHeader."Due Date");
        EDocumentXMLHelper.SetStringValueInField(FacturaEXML, XmlNamespaces, '/fe:Facturae/Invoices/Invoice/Corrective/InvoiceNumber', MaxStrLen(EDocumentPurchaseHeader."Purchase Order No."), EDocumentPurchaseHeader."Purchase Order No.");
...
#pragma warning restore AA0139
    ...
    var
        ...
        LineXMLNode: XmlNode;
        i: Integer;
        InvoiceLinePathLbl: Label '/fe:Facturae/Invoices/Invoice/Items/InvoiceLine';
    begin
...
#pragma warning restore AA0139
    ...
    begin
        ...
        if FacturaEXML.SelectSingleNode('/fe:Facturae/Parties/SellerParty/TaxIdentification/TaxIdentificationNumber', XmlNamespaces, XMLNode) then
        ...
        if VendorNo = '' then begin
            if FacturaEXML.SelectSingleNode('/fe:Facturae/Parties/SellerParty/PartyIdentification', XmlNamespaces, XMLNode) then
        ...
        if VendorNo = '' then begin
            VendorName := GetNameDependingOnType(FacturaEXML, XmlNamespaces, '/fe:Facturae/Parties/SellerParty/');
            VendorAddress := GetAddressDependingOnType(FacturaEXML, XmlNamespaces, '/fe:Facturae/Parties/SellerParty/');
        ...
        if Vendor."No." <> '' then begin
            ...
            EDocumentPurchaseHeader."Vendor Address" := CopyStr(GetAddressDependingOnType(FacturaEXML, XmlNamespaces, '/fe:Facturae/Parties/SellerParty/'), 1, MaxStrLen(EDocumentPurchaseHeader."Vendor Address"));
        end else begin
    ...
    var
        ...
        XMLNode: XmlNode;
    begin
        BuyerName := GetNameDependingOnType(FacturaEXML, XmlNamespaces, '/fe:Facturae/Parties/BuyerParty/');
        BuyerAddress := GetAddressDependingOnType(FacturaEXML, XmlNamespaces, '/fe:Facturae/Parties/BuyerParty/');
        ...
        if FacturaEXML.SelectSingleNode('/fe:Facturae/Parties/BuyerParty/TaxIdentification/TaxIdentificationNumber', XmlNamespaces, XMLNode) then
